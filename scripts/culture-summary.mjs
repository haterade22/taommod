...
const raw = execSync(`node "${join(__dirname, 'tw-damage-calc.mjs')}"`, {
  encoding: 'utf8',
...
const MAP = {
  ...
  dunland_raiders: 'dunland',
  erebor_warriors: 'erebor',
  gondor_soldiers: 'gondor',
  gundabad_raiders: 'gundabad',
  harad_raiders: 'harad',
  mirkwood_stalkers: 'mirkwood',
  rhun_raiders: 'rhun',
  umbar_corsairs: 'umbar',
};
const byCulture = {};
...
const entries = Object.entries(byCulture)
  .map(([c, d]) => ({
    culture: c,
    count: d.n,
    avgSwing: avg(d.sw),
...
console.log(
  'Culture'.padEnd(16) +
    'Count'.padStart(6) +
    'AvgSwing'.padStart(10) +
    'AvgThrust'.padStart(10) +
    'AvgMelee'.padStart(10) +
    'AvgSpeed'.padStart(10) +
    'Pct'.padStart(6),
);
