...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Faction[@id='clan_empire_north_1']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="color">FF41211D</xsl:attribute>
      <xsl:attribute name="color2">FF71232F</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF472820</xsl:attribute>
      <xsl:attribute name="color2">FF78262C</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF4E2E23</xsl:attribute>
      <xsl:attribute name="color2">FF7E2828</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_4']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'initial_home_settlement' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF543525</xsl:attribute>
      <xsl:attribute name="color2">FF85302A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF5A3D28</xsl:attribute>
      <xsl:attribute name="color2">FF8C3A2C</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF60452B</xsl:attribute>
      <xsl:attribute name="color2">FF93442E</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF664E2D</xsl:attribute>
      <xsl:attribute name="color2">FF9A4F30</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF6D5730</xsl:attribute>
      <xsl:attribute name="color2">FFA05B32</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_north_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.181.166.1528.1528.764.764.1.0.0.26004.2000.171.650.650.765.800.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF736133</xsl:attribute>
      <xsl:attribute name="color2">FFA76835</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dunland_empire_north_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_1']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF100E0F</xsl:attribute>
      <xsl:attribute name="color2">FF5F102A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF1A1717</xsl:attribute>
      <xsl:attribute name="color2">FF7E1518</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF1D1A19</xsl:attribute>
      <xsl:attribute name="color2">FF821716</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF1F1C1C</xsl:attribute>
      <xsl:attribute name="color2">FF871D16</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_5']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'initial_home_settlement' and local-name() != 'culture' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="color">FF221F1E</xsl:attribute>
      <xsl:attribute name="color2">FF8B2317</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF252121</xsl:attribute>
      <xsl:attribute name="color2">FF8F2918</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF282423</xsl:attribute>
      <xsl:attribute name="color2">FF943019</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF2A2725</xsl:attribute>
      <xsl:attribute name="color2">FF983619</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_empire_south_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="color2">FF9D3E1A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_mordor_empire_south_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_1']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF163D52</xsl:attribute>
      <xsl:attribute name="color2">FFC0652A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF183D59</xsl:attribute>
      <xsl:attribute name="color2">FFC8752C</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF1A3D60</xsl:attribute>
      <xsl:attribute name="color2">FFCF852D</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF1C3C67</xsl:attribute>
      <xsl:attribute name="color2">FFD29633</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF1E3A6E</xsl:attribute>
      <xsl:attribute name="color2">FFD4A53A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF203775</xsl:attribute>
      <xsl:attribute name="color2">FFD6B341</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF22347C</xsl:attribute>
      <xsl:attribute name="color2">FFD7C149</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF243083</xsl:attribute>
      <xsl:attribute name="color2">FFD9CE50</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_sturgia_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.312.166.1528.1528.764.764.1.0.0.27000.238.171.900.900.765.790.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF262B8A</xsl:attribute>
      <xsl:attribute name="color2">FFDADA57</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_dale_sturgia_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_1']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF701631</xsl:attribute>
      <xsl:attribute name="color2">FFAB6121</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF78182D</xsl:attribute>
      <xsl:attribute name="color2">FFB37023</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">4</xsl:attribute>
      <xsl:attribute name="color">FF7F1928</xsl:attribute>
      <xsl:attribute name="color2">FFBA7F24</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">4</xsl:attribute>
      <xsl:attribute name="color">FF871B23</xsl:attribute>
      <xsl:attribute name="color2">FFC29026</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">4</xsl:attribute>
      <xsl:attribute name="color">FF8E1C1C</xsl:attribute>
      <xsl:attribute name="color2">FFC9A227</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF95261D</xsl:attribute>
      <xsl:attribute name="color2">FFD0B528</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">3</xsl:attribute>
      <xsl:attribute name="color">FF9D321F</xsl:attribute>
      <xsl:attribute name="color2">FFD6C72C</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">3</xsl:attribute>
      <xsl:attribute name="color">FFA43E20</xsl:attribute>
      <xsl:attribute name="color2">FFD7D533</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_aserai_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="tier">4</xsl:attribute>
      <xsl:attribute name="color">FFAC4B22</xsl:attribute>
      <xsl:attribute name="color2">FFD0D93B</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_harad_aserai_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_1']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'banner_key' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="color">FF344B24</xsl:attribute>
      <xsl:attribute name="color2">FFD7B48E</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF356430</xsl:attribute>
      <xsl:attribute name="color2">FFE0D7A9</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF346D35</xsl:attribute>
      <xsl:attribute name="color2">FFE4E2B3</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF357037</xsl:attribute>
      <xsl:attribute name="color2">FFE5E4B6</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF36723A</xsl:attribute>
      <xsl:attribute name="color2">FFE5E6B8</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_6']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'initial_home_settlement' and local-name() != 'banner_key' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF37743D</xsl:attribute>
      <xsl:attribute name="color2">FFE5E7BB</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_7']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'owner' and local-name() != 'banner_key' and local-name() != 'color' and local-name() != 'color2' and local-name() != 'default_party_template']"/>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF387740</xsl:attribute>
      <xsl:attribute name="color2">FFE5E8BD</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF397943</xsl:attribute>
      <xsl:attribute name="color2">FFE5E8C0</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF3A7B46</xsl:attribute>
      <xsl:attribute name="color2">FFE5E9C2</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_10']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF344D25</xsl:attribute>
      <xsl:attribute name="color2">FFD8B790</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_10_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_vlandia_11']">
    <xsl:copy>
      ...
      <xsl:attribute name="banner_key">11.272.272.1528.1528.764.764.1.0.0.21007.172.171.700.700.764.764.0.0.0</xsl:attribute>
      <xsl:attribute name="color">FF354F26</xsl:attribute>
      <xsl:attribute name="color2">FFD8BB93</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rohan_vlandia_11_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_1']">
    <xsl:copy>
      <xsl:apply-templates select="@*[local-name() != 'name' and local-name() != 'initial_home_settlement' and local-name() != 'color' and local-name() != 'color2']"/>
      ...
      <xsl:attribute name="color">FF6D2D18</xsl:attribute>
      <xsl:attribute name="color2">FF3E101A</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF753919</xsl:attribute>
      <xsl:attribute name="color2">FF461319</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF7D451B</xsl:attribute>
      <xsl:attribute name="color2">FF4E1517</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF86531D</xsl:attribute>
      <xsl:attribute name="color2">FF561A17</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF8E621F</xsl:attribute>
      <xsl:attribute name="color2">FF5E2219</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF977121</xsl:attribute>
      <xsl:attribute name="color2">FF662C1B</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FF9F8223</xsl:attribute>
      <xsl:attribute name="color2">FF6E361D</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_battania_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFA79424</xsl:attribute>
      <xsl:attribute name="color2">FF764120</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_1']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFA35A27</xsl:attribute>
      <xsl:attribute name="color2">FF3D0E18</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_1_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_2']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFC6A530</xsl:attribute>
      <xsl:attribute name="color2">FF602115</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_2_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_3']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFCAAD30</xsl:attribute>
      <xsl:attribute name="color2">FF642516</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_3_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_4']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFCDB531</xsl:attribute>
      <xsl:attribute name="color2">FF672817</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_4_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_5']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFCEBC34</xsl:attribute>
      <xsl:attribute name="color2">FF6A2C18</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_5_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_6']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFCFC237</xsl:attribute>
      <xsl:attribute name="color2">FF6D3118</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_6_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_7']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFD0C83A</xsl:attribute>
      <xsl:attribute name="color2">FF713519</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_7_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_8']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFD1CD3D</xsl:attribute>
      <xsl:attribute name="color2">FF743A1A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_8_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
  ...
  <xsl:template match="Faction[@id='clan_khuzait_9']">
    <xsl:copy>
      ...
      <xsl:attribute name="color">FFD0D140</xsl:attribute>
      <xsl:attribute name="color2">FF773E1A</xsl:attribute>
      <xsl:attribute name="default_party_template">PartyTemplate.kingdom_hero_party_rhun_khuzait_9_template</xsl:attribute>
      <xsl:apply-templates select="node()"/>
    </xsl:copy>
  </xsl:template>
